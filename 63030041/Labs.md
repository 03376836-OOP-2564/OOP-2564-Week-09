...
```
  ...
  [จากการพิจารณา การทำงานใน Static void main จะทำงานโดยเเสดงค่า value ของตัวเเปรชนิดต่างๆเเบบค่า เริ่มต้นเพราะยังไม่ได้กำหนดค่าให้กับตัวเเปรใดๆเลย
...
```
  ...
  ![image](https://user-images.githubusercontent.com/92078775/167894234-3f42218d-a594-4563-8b62-fff8f28838de.png)
...
```
  ...
  ![image](https://user-images.githubusercontent.com/92078775/167896729-76f19a45-ae1f-4727-92f4-810593903b11.png)

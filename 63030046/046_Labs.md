...
```
     ...
     คิดว่าผลการรันโปรแกรมจะเริ่มที่ class Program เป็นอันดับแรก เพราะมี static void Main() ในการทำงานครั้งแรก และก็จะการสร้างตัวแปร mc มาเก็บค่าของ class Myclass ที่ประกาศสร้างมาใหม่ จากนั้นจะแสดงข้อมูลที่อยู่ใน class Myclass ผ่าน Command Line 
...
```
     ...
     ค่อนข้างตรงกับสิ่งที่คิดไว้เพราะโปรแกรมจะเริ่มที่ class Program เป็นอันดับแรก และก็จะการสร้างตัวแปร mc มาเก็บค่าของ class Myclass ที่ประกาศสร้างมาใหม่ จากนั้นจะแสดงข้อมูลที่อยู่ใน class Myclass ผ่าน Command Line 
...
```
   ...
   คิดว่าผลการรันโปรแกรมจะเริ่มที่ class Program เป็นอันดับแรก เพราะมี static void Main() ในการทำงานครั้งแรกโปรแกรมน่าจะไม่สามารถทำงานได้ เพราะมีการเรียกใช้งาน private 
...
![image](https://user-images.githubusercontent.com/91675464/167895492-e2215537-2044-4b6a-8786-54cfce258996.png)


4. ผลที่ได้เหมือนหรือต่างจากที่คิดไว้อย่างไร  
```

     ค่อนข้างตรงกับสิ่งที่คิดไว้ เพราะโปรแกรมมีการเรียกใช้ค่าของ private และ protected ใน class ATM โปรแกรมไม่สามารถทำงานได้

...
```
  ...
  ตัวโปรแกรมจะเรียกการทำงานหรือเรียกใช้งาน class Program เป็นอันดับแรกเพราะมี  static void Main()
  ส่วนใน  static void Main() จะมีหรือเก็บค่า class ที่มาสร้างตัวแปร MyClass mc ที่เก็บค่าของ  class MyClass เมื่อรันโปรแกรม
...
```
![image](https://user-images.githubusercontent.com/92082240/169643674-0257d5ad-5acc-4d52-8d93-6a9cb730dbcc.png)
...
```
  ...
  โปรแกรมเกืดการ Error หรือก็คือไม่สามารถรันการทำงานของโปรแกรมได้เพราะมีการเรียกใช้ private
...
```   
![image](https://user-images.githubusercontent.com/92082240/169643991-fc399c57-a4d6-477e-8848-7c4448eb0f24.png)
...
```
  ...
  [ให้เขียนบรรยายตรงนี้]
  ตรงกับการที่คาดหวังไว้เพราะมีการเรียกใช้ private จึงทำให้ไม่สามารถทำการรันได้

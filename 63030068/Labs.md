...
```
  ...
  เมื่อรันโปรแกรมแล้ว โปรแกรมจะแสดงผล default value ของตัวแปรต่างๆ ใน class ของ MyClass ผ่านการสร้าง Object mc
...
3. บันทึกผล
![image](https://user-images.githubusercontent.com/50146617/163687703-544a23ff-3f77-4fb7-b080-da2c4ffffde0.png)


4. ผลที่ได้เหมือนหรือต่างจากที่คิดไว้อย่างไร  
```

  ไม่ต่างจากที่คิดไว้ข้างต้น
...
```
  ...
  โปรแกรมจะ Error เนื่องจากการประกาศตัวแปรเป็นแบบ private และ protected จึงไม่สามารถนำตัวแปร 2 ตัวแปรนี้มาเรียกใช้งานใน class Program ได้
...
2. สร้าง project แล้วรันโปรแกรม
3. บันทึกผล
![image](https://user-images.githubusercontent.com/50146617/163688055-1ff37090-6f04-43f9-85ca-fb7db675f667.png)

...
```
  ...
  ผลการรัน ตัวแปรที่เป็นชนิดตัวเลขน่าจะแสดงออกมาเป็น 0 ส่วนตัวแปรที่เป็นชนิดข้อความน่าจะแสดงออกมาเป็น null
...
![image](https://user-images.githubusercontent.com/92078869/163710748-a9e63444-3409-4d22-afe1-05dc8476ba50.png)


4. ผลที่ได้เหมือนหรือต่างจากที่คิดไว้อย่างไร  
```

  เหมือนอย่างที่คิดไว้ เพราะถ้าเราไม่กำหนดค่าให้ตัวแปรชนิดตัวเลข ผลลัพธ์จะแสดงออกมาเป็น 0 แต่ถ้าเป็นตัวแปรชนิดข้อความผลลัพธ์จะแสดงออกมาเป็น null ถ้าเป็น bool จะแสดงค่า false

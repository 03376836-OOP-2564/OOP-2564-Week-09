...
```
![image](https://user-images.githubusercontent.com/92082349/169661397-7def0726-3453-4efb-8454-27ed12ff384a.png)
...
```   
 ![image](https://user-images.githubusercontent.com/92082349/169661445-6eb2950a-8d1c-4ee0-bef2-1d467697427c.png)

4. ผลที่ได้เหมือนหรือต่างจากที่คิดไว้อย่างไร  
```

  [ให้เขียนบรรยายตรงนี้]
  ตรงกับการที่คาดหวังไว้เพราะมีการเรียกใช้ private จึงทำให้ไม่สามารถรันได้

...
```
  ...
  [เมื่อรันแล้วจะแสดงข้อมูลที่อยู่ใน class  myclass จะมีการแสดงผลออกมาเป็น 0 และจะค่า null]
...
```
  ...
  ![image](https://user-images.githubusercontent.com/92079514/168600325-487f4d9b-49d7-4ca2-9e01-a8805d6898b6.png)
...
```
  ...
  [เหมือน เพราะเมื่อเราไม่กำหนดค่าของตัวแปร ตัวผลลัพธ์ที่จะแสดงออกมาจะเป็น 0 หรือ null นั้นเอง]
...
```
  ...
  ![image](https://user-images.githubusercontent.com/92079514/168601462-cae04b0c-6338-443f-a182-94bea142ad21.png)
...
```
  ...
  [เหมือน เพราะโปรแกรมมีการเรียกใช้ค่า private และ ค่า protected แต่จะใช้ค่าแค่ใน class ของมันเอง แต่จะไม่สามารถใช้ใน class อื่นได้]

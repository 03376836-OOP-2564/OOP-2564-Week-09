...
```
  ...
  โปรแกรมจะรันแล้วจะเรียกใช้งาน class Program เป็นอันดับแรก เพราะมี static void main() อยู่ใน class จากนั้นจะทำการสร้างตัวแปร mc มาเก็นค่าของ 
...
```
  ...
  ค่อนข้างตรงกับสิ่งที่คิดไว้ เนื่องจากเราไม่ได้ทำการกำหนดค่าให้ตัวแปรใน class MyClass ตัวคอมไพรเลอร์เลยกำหนดค่าเริ่มต้นให้ตัวแปรเป็น 0 หรือเป็นค่า null
...
```
  ...
  โปรแกรมน่าจะไม่สามารถทำงานได้ เพระามีการเรียกใช้ค่าของ private และ protected
...
3. บันทึกผล
  ...
  ![picture3](https://user-images.githubusercontent.com/92082676/169660772-2c9ca9ac-7ef1-4281-83a6-54f310bddc54.png)

4. ผลที่ได้เหมือนหรือต่างจากที่คิดไว้อย่างไร  
```

  ค่อนข้างตรงกับสิ่งที่คิดไว้ เพราะโปรแกรมมีการเรียกใช้ค่าของ private และ protected ใน class ATM ซึ่งตัวแปรที่เป็นค่า private และ protected จะใช้ได้แค่ใน class ของมัน ไม่สามารถถูกเรียกใช้โดย class อื่นได้

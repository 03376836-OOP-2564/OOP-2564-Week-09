...
3. บันทึกผล
 ...
 ![image](https://user-images.githubusercontent.com/92086229/169657829-dd0562cd-56e7-4434-ae9c-b24c799bbed4.png)
4. ผลที่ได้เหมือนหรือต่างจากที่คิดไว้อย่างไร  
```

  ค่อนข้างตรงกับสิ่งที่คิดไว้ เนื่องจากเราไม่ได้ทำการกำหนดค่าให้ตัวแปรใน class MyClass ตัวคอมไพเลอร์เลยกำหนดค่าเริ่มต้นให้ตัวแปรเป็น 0 หรือเป็นค่า null
...
```
   ...
   โปรแกรมน่าจะไม่สามารถทำงานได้ เพราะมีการเรียกใช้ค่าของ private และ protected
...
2. สร้าง project แล้วรันโปรแกรม
3. บันทึกผล
 ![image](https://user-images.githubusercontent.com/92086229/169657904-4f90057d-f163-4e25-bfbd-306dfd4e213f.png)

...
จะการสร้างตัวแปร mc มาเก็บค่าของ class Myclass ที่ประกาศสร้างมาใหม่ จากนั้นจะแสดงข้อมูลที่อยู่ใน class Myclass ผ่าน Command Line 
...
3. บันทึกผล
  ...
  [บันทึกผล]
  ![image](https://user-images.githubusercontent.com/92081596/168600134-3e9c8a42-98e4-477e-920b-c1ec7f735cf0.png)
...
```
 ...
 เหมือนที่คิดไว้ เพราะโปรแกรม เริ่มทำงานจาก class Program และไปเก็บค่าไว้ class MyClass และก็ไปแสดงค่าผ่าน command line
...
```
  ...
  โปรแกรมจะเริ่มที่ class Program เป็นอันดับแรก เพราะมี static void Main() และในการทำงานครั้งแรกโปรแกรมน่าจะไม่สามารถทำงานได้ เพราะมีการเรียกใช้งาน private และ protected
...
3. บันทึกผล
 ...
 ![image](https://user-images.githubusercontent.com/92081596/168605039-40e6ac47-0e9b-4987-8fb7-e53c06656d44.png)
